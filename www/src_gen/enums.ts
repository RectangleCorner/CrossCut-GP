...
export enum AmbientEffectType {
    AL_CUSTOM_EFFECT_STATIC_COLOR = 0,
    AL_CUSTOM_EFFECT_GRADIENT = 1,
    AL_CUSTOM_EFFECT_CHASE = 2,
    AL_CUSTOM_EFFECT_BREATH = 3,
    AL_CUSTOM_EFFECT_STATIC_THEME = 4
}
