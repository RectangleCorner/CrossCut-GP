...
#define BUTTON_GROUP_STICKLESS_BUTTONS                                                         \
    {                                                                                          \
        {GP_ELEMENT_BTN_BUTTON, {93, 27, 4, 4, 1, 1, GAMEPAD_MASK_B1, GP_SHAPE_ELLIPSE}},      \
            ...
            {GP_ELEMENT_BTN_BUTTON, {112, 24, 4, 4, 1, 1, GAMEPAD_MASK_R2, GP_SHAPE_ELLIPSE}}, \
            {GP_ELEMENT_BTN_BUTTON, {122, 29, 4, 4, 1, 1, GAMEPAD_MASK_L2, GP_SHAPE_ELLIPSE}}, \
            {GP_ELEMENT_BTN_BUTTON, {90, 52, 4, 4, 1, 1, GAMEPAD_MASK_L3, GP_SHAPE_ELLIPSE}},  \
            {GP_ELEMENT_BTN_BUTTON, {90, 40, 4, 4, 1, 1, GAMEPAD_MASK_R3, GP_SHAPE_ELLIPSE}},  \
        {                                                                                      \
